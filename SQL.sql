...
CREATE TABLE AccountTypeDataSet (id int IDENTITY NOT NULL, AccountType varchar(50) NOT NULL, PRIMARY KEY (id));
...
CREATE TABLE Currencies (id int IDENTITY NOT NULL, Currency varchar(20) NOT NULL, ExhangeRate float(10) NOT NULL, PRIMARY KEY (id));
